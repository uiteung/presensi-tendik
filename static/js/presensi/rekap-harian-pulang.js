...
function html_table_to_excel(type) {
	...
	XLSX.writeFile(file, 'Rekap Presensi Pulang Harian.' + type);
}
...
exportPdfButton.addEventListener('click', () => {
	...
	doc.text('Rekap Presensi Pulang Harian', 10, 10);
	const rows = document.getElementById('examplePulang').querySelectorAll('tr');
	const tableData = [];
	...
	doc.save('Rekap Presensi Pulang Harian.pdf');
});
